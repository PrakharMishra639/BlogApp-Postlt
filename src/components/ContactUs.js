...
const ContactUs = () => {
  return (
    ...
    <div className="container px-6 py-12 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
            <div className="flex flex-col items-center justify-center text-center">
                ...
                <p className="mt-2 text-blue-500 dark:text-blue-400">postlt@gmail.com</p>
            </div>
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                <div className="bg-blue-50 p-7">
                    <span className="inline-block  text-blue-500 rounded-lg bg-blue-100/80 dark:bg-gray-800 p-3 ">
                    ...
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">postlt@gmail.com</p>
                </div>
    ...
    <div className="flex flex-col justify-center items-center w-full p-8 lg:bg-gray-100 lg:dark:bg-gray-800 lg:px-12   xl:px-32">
        ...
        <div className="mt-6 md:mt-8">
            <h3 className="font-medium text-gray-600 dark:text-gray-300  text-center">Follow us</h3>

            <div className="flex mt-4 -mx-1.5 ">
                <Link className="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500" to="/">
