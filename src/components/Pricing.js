           ...
           <div className="flex items-center justify-between max-w-2xl px-8 py-4 mx-auto border cursor-pointer rounded-xl dark:border-gray-700">
               <div className="flex items-center">
                   ...
                   <div className="flex flex-col items-center mx-5 space-y-1">
                       <h2 className="text-lg font-medium text-gray-700 sm:text-2xl dark:text-gray-200">Free</h2>
               ...
               <h2 className="text-2xl font-semibold text-gray-500 sm:text-3xl dark:text-gray-300">$0 <span className="text-base font-medium">/Month</span></h2>
           </div>
