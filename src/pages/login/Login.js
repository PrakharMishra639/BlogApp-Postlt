...
const submitHandler = (data) => {
  ...
  return (
    ...
    <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
      ...
      <h2 class="mt-6 text-center text-2xl font-roboto font-bold text-gray-900">
            Sign in to your account
        </h2>
        <p class="mt-2 text-center text-sm text-gray-600 max-w">
               Or <span> </span>

            <Link to="/register" class="font-medium text-blue-600 hover:text-blue-500">
                create an account
            </Link>
        </p>
        <form onSubmit = { handleSubmit(submitHandler) } className="">
          ...
          <button type="submit" disabled={!isValid || isLoading} className="bg-primary text-white font-bold text-lg
            py-4 px-8 w-full rounded-lg my-6 disabled:opacity-70 disabled:cursor-not-allowed" >
            Sign In
          </button>
          <div class="relative ">
          ...
          <p className="text-sm text-center mt-8 font-semibold text-[#5a7184] ">
