    ...
    <div className="col-span-4 py-8">
     ...
     <div className="d-form-control w-full mt-6">
         ...
         className="d-input d-input-bordered border-slate-300 !outline-slate-300 text-xl  md:text-[26px]font-medium font-roboto  text-dark-hard" />
           <button disabled={isLoadingCreateCategory } type="button " onClick={handleCreateCategory} className="disabled:cursor-not-allowed mt-3 disabled:opacity-70 w-fit bg-green-500 text-white font-semibold rounded-lg px-4 py-2">
            Add Category
          </button>
         </div>
   </div>
